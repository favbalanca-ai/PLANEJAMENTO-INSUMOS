...
const APP_VERSION = '2026.07.06-25';   // mostrado no rodapé; ajude a confirmar se a atualização chegou
...
const comprasEmpSel = new Set();   // filtro da Demanda de Compras (independente) — sessão
V.compras = function(){
