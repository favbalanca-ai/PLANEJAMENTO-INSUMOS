...
const APP_VERSION = '2026.07.28-101';   // mostrado no rodapé; ajude a confirmar se a atualização chegou
...
function countEdits(){
  return Object.keys(OV.estoque).length + Object.keys(OV.pedido).length + Object.keys(OV.dose).length +
         ...
         Object.keys(OV.opMaq).length + Object.keys(OV.arrend).length + Object.keys(OV.dreCfg||{}).length + Object.keys(OV.dreUnit||{}).length + Object.keys(OV.dreProdHa||{}).length + (OV.diesel!==6.00?1:0) +
...
function recomLink(r){
  ...
  let tanque=0; if(r.opKey){ const rl=realOf(r.opKey); if(rl&&rl.app&&rl.app.tanque!=null&&rl.app.tanque!=='') tanque=+rl.app.tanque||0; }
