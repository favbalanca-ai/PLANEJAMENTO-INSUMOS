...
V.dre = function(){
  ...
  const R=list.map(([e,g])=>{
    ...
    return {e,g,unit,prod,prodHa,preco,opHa,arrHa,receita,custoMaq,custoVar,custoArr,estrutura,imposto,financeiro,outras,receitaLiq,margContrib,resultOper,resultLiq,custoTot,precoEq,prodEq,margSeg,resHa,custoSaca,margLiq};
  });
