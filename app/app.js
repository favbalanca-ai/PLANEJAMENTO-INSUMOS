...
const APP_VERSION = '2026.07.28-77';   // mostrado no rodapé; ajude a confirmar se a atualização chegou
...
V.compras = function(){
  ...
  <div class="toolbar"><div class="search"><input id="q-compra" placeholder="Buscar produto, classe ou fornecedor…"></div>
    <div class="spacer"></div><span class="badge badge-muted">${(sel.size||tsel.size)?'Demanda só do que foi selecionado (estoque/pedido são globais). ':''}A comprar = máx(0; Demanda restante − Saldo − Em pedido). Saldo = Estoque − aplicado (recom. aprovadas).</span></div>
