...
const APP_VERSION = '2026.07.28-131';   // mostrado no rodapé; ajude a confirmar se a atualização chegou
...
// estádios de uma safra do talhão: [{cod,desc,dae,data}] — plantio (realizado > previsto) + dias × (ciclo/ciclo de referência)
function estadiosDe(t,seq){ const F=FENO[culturaKey(seq==='safrinha'?empSafDe(t):empDe(t))]||null, pl=plantioEffDe(t.id,seq);
  if(!F||!pl) return {F,pl,list:[]};
