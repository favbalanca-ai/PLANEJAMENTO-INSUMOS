...
const APP_VERSION = '2026.07.18-37';   // mostrado no rodapé; ajude a confirmar se a atualização chegou
...
const VIEW_MOD = { inicio:'both', dashboard:'planejamento', talhoes:'planejamento', talhao:'planejamento',
  ...
  maquinas:'planejamento', dre:'planejamento', campo:'campo', monitoramento:'campo', chuva:'campo', sync:'both' };
...
function boot(d){
  DATA=d; PROD={}; d.produtos.forEach(p=>PROD[p.produto]=p);
  loadOverrides(); PRECOS=loadPrecos(); MONIT=loadMonit(); CHUVA=loadChuva(); buildMaqIndex(); updateEditBadge();
